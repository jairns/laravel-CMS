...
<head>
    ...
    <meta name='description' content="@yield('page_description', 'My Blog about building my laravel blog, meta in meta')">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li><a class="nav-link{{Request::is('/') ? ' active' : ''}}" href='/'>About</a></li>
                        @auth
